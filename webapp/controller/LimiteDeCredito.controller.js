	...
	return BaseController.extend("com.sap.build.h12f10161-us_3.dashboardTabelas.controller.LimiteDeCredito", {
		...
		_onOverflowToolbarButtonPress: function(oEvent) {
			...
			var confirmHandler = function(oConfirmEvent) {
				...
				vValueLT = oDialog.getModel().getProperty("/Codigo/vValueLT");
				vValueGT = oDialog.getModel().getProperty("/Codigo/vValueGT");
				if (vValueLT !== "" || vValueGT !== "") {
					oFilter = this.getCustomFilter("Codigo", vValueLT, vValueGT);
					oBindingData.filters.push(oFilter);
					sFilterString = sFilterString ? sFilterString + ', ' : 'Filtered by: ';
					sFilterString += this.getCustomFilterString(true, "Codigo", oFilter.sOperator, vValueLT, vValueGT);
				}

				vValueLT = oDialog.getModel().getProperty("/ValordoLimite/vValueLT");
				vValueGT = oDialog.getModel().getProperty("/ValordoLimite/vValueGT");
				if (vValueLT !== "" || vValueGT !== "") {
					oFilter = this.getCustomFilter("ValordoLimite", vValueLT, vValueGT);
					oBindingData.filters.push(oFilter);
					sFilterString = sFilterString ? sFilterString + ', ' : 'Filtered by: ';
					sFilterString += this.getCustomFilterString(true, "ValordoLimite", oFilter.sOperator, vValueLT, vValueGT);
				}

				vValueLT = oDialog.getModel().getProperty("/LimitedeCredito/vValueLT");
				vValueGT = oDialog.getModel().getProperty("/LimitedeCredito/vValueGT");
				if (vValueLT !== "" || vValueGT !== "") {
					oFilter = this.getCustomFilter("LimitedeCredito", vValueLT, vValueGT);
					oBindingData.filters.push(oFilter);
					sFilterString = sFilterString ? sFilterString + ', ' : 'Filtered by: ';
					sFilterString += this.getCustomFilterString(true, "LimitedeCredito", oFilter.sOperator, vValueLT, vValueGT);
				}
			...
			function resetFiltersHandler() {
				...
				oDialog.getModel().setProperty("/Codigo/vValueLT", "");
				oDialog.getModel().setProperty("/Codigo/vValueGT", "");

				oDialog.getModel().setProperty("/ValordoLimite/vValueLT", "");
				oDialog.getModel().setProperty("/ValordoLimite/vValueGT", "");

				oDialog.getModel().setProperty("/LimitedeCredito/vValueLT", "");
				oDialog.getModel().setProperty("/LimitedeCredito/vValueGT", "");
			...
			function updateDialogData(filters) {
				var mParams = {
					...
					success: function(oData) {
						...
						oJsonModelDialogData["Codigo"] = {
							vValueLT: (oDialogModel && oDialogModel.getProperty("/Codigo")) ? oDialogModel.getProperty("/Codigo/vValueLT") : "",
							vValueGT: (oDialogModel && oDialogModel.getProperty("/Codigo")) ? oDialogModel.getProperty("/Codigo/vValueGT") : ""
						};

						oJsonModelDialogData["ValordoLimite"] = {
							vValueLT: (oDialogModel && oDialogModel.getProperty("/ValordoLimite")) ? oDialogModel.getProperty("/ValordoLimite/vValueLT") : "",
							vValueGT: (oDialogModel && oDialogModel.getProperty("/ValordoLimite")) ? oDialogModel.getProperty("/ValordoLimite/vValueGT") : ""
						};

						oJsonModelDialogData["LimitedeCredito"] = {
							vValueLT: (oDialogModel && oDialogModel.getProperty("/LimitedeCredito")) ? oDialogModel.getProperty("/LimitedeCredito/vValueLT") : "",
							vValueGT: (oDialogModel && oDialogModel.getProperty("/LimitedeCredito")) ? oDialogModel.getProperty("/LimitedeCredito/vValueGT") : ""
						};
